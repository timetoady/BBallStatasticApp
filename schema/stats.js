...
let Stats = new Schema({
    ...
    fga: {type: Number, min: 0},
    fgm: {type: Number, min: 0},
    fta: {type: Number, min: 0},
    ftm: {type: Number, min: 0},
    assists: {type: Number, min: 0},
    steals: {type: Number, min: 0},
    blocks: {type: Number, min: 0},
    fouls: {type: Number, min: 0},
    tos: {type: Number, min: 0},
